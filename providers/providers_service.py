...
from config.consts import KEEP_STORE_PROVIDER_LOGS, KEEP_API_URL
...
from event_subscriber.event_subscriber import EventSubscriber
...
class ProvidersService:
    ...
    def get_provider_logs(
        ...
        if not KEEP_STORE_PROVIDER_LOGS:
