...
from config.consts import KEEP_READ_ONLY_BYPASS_KEY
...
from identitymanager.rbac import Role
from identitymanager.rbac import Webhook as WebhookRole
...
def get_api_keys_secret(
    ...
    for api_key in api_keys:
        ...
        try:
            ...
            read_only_bypass_key = KEEP_READ_ONLY_BYPASS_KEY
