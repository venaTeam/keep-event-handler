...
from src.core.db.db import get_all_deduplication_rules, delete_deduplication_rule, update_deduplication_rule, create_deduplication_rule
from src.config.consts import ENV_VAR_KEY
...
def provision_deduplication_rules(deduplication_rules: dict[str, any], tenant_id: str):
    ...
    all_deduplication_rules_from_db = get_all_deduplication_rules(tenant_id)
