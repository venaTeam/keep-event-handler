...
from src.config.consts import KEEP_DEDUPLICATION_DISTRIBUTION_ENABLED, KEEP_CUSTOM_DEDUPLICATION_DISTRIBUTION_ENABLED
...
class AlertDeduplicator:
    ...
    CUSTOM_DEDUPLICATION_DISTRIBUTION_ENABLED = KEEP_CUSTOM_DEDUPLICATION_DISTRIBUTION_ENABLED
