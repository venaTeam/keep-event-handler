...
from src.config.consts import TENANT_CONFIGURATION_RELOAD_TIME
from src.core.db.db import get_tenants_configurations
...
class TenantConfiguration:
    ...
    class _TenantConfiguration:
        def __init__(self):
            ...
            self.reload_time = TENANT_CONFIGURATION_RELOAD_TIME
