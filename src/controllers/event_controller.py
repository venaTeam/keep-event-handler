...
from src.core.db.db import enrich_entity, delete_alert
...
def _process_batch_enrich_event(event_dto: EventDTO):
    from src.core.db.db import batch_enrich
...
def _process_incident_event(event_dto: EventDTO):
    from src.core.db.db import create_incident_from_dict, delete_incident_by_id, update_incident_from_dto_by_id
