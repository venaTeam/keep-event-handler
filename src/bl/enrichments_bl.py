...
from src.config.consts import ENRICHMENT_DISABLED
...
from src.core.db.db import enrich_entity as enrich_alert_db
...
from src.models.db.enrichment_event import (
    EnrichmentEvent,
    EnrichmentLog,
    EnrichmentStatus,
    EnrichmentType,
...
class EnrichmentsBl:
    ...
    def _apply_dispose_on_new_alert(enrichments: dict, dispose_on_new_alert: bool) -> dict:
        ...
        previously-disposable status/dismiss back to non-disposable. Enrichments
        that carry neither status nor dismiss_mode (e.g. note/ticket/mapping
        writes) are left untouched so they never reset the flag.
        """
