...
from src.core.sse import notify_sse
from src.core.metrics import alerts_maintenance_silenced_total
from src.models.action_type import ActionType
from src.models.alert import AlertDto, AlertStatus
from src.models.db.alert import Alert, AlertAudit
...
class MaintenanceWindowsBl:
    ...
    def recover_strategy(
        ...
        call, eventually exhausting the pool.
        """
