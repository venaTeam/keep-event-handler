...
from src.config.consts import KEEP_CLOUDWATCH_DISABLE_API_KEY, KEEP_IMPERSONATION_ENABLED, KEEP_IMPERSONATION_ROLE_HEADER, KEEP_IMPERSONATION_USER_HEADER, KEEP_READ_ONLY_BYPASS_KEY, KEEP_UPDATE_KEY_INTERVAL, KEEP_IMPERSONATION_AUTO_PROVISION, KEEP_READ_ONLY
from src.core.db.db import get_api_key, update_key_last_used
from src.core.dependencies import extract_generic_body
from src.identitymanager.authenticatedidentity import AuthenticatedEntity
...
class AuthVerifierBase:
    ...
    def __init__(self, scopes: list[str] = []) -> None:
        ...
        self.impersonation_enabled = KEEP_IMPERSONATION_ENABLED
        self.impersonation_user_header = KEEP_IMPERSONATION_USER_HEADER
        self.impersonation_role_header = KEEP_IMPERSONATION_ROLE_HEADER
        self.impersonation_auto_provision = KEEP_IMPERSONATION_AUTO_PROVISION
        ...
        self.update_key_interval = KEEP_UPDATE_KEY_INTERVAL
        self.key_last_used_updates = {}
        # check if read only instance
        self.read_only = KEEP_READ_ONLY
        self.read_only_bypass_keys = KEEP_READ_ONLY_BYPASS_KEY.split(",")
    ...
    def _extract_api_key(
        ...
        if not api_key:
            ...
            if (
                ...
                allow_unauth = KEEP_CLOUDWATCH_DISABLE_API_KEY
