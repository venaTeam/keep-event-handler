...
@pytest.mark.skip(reason="Relies on arq worker context and API gateway specific enrichment logic")
...
@pytest.mark.skip(reason="Event-handler does not execute workflows")
...
def test_alert_enrichment_via_api_uuid(db_session, client, test_app, create_alert):
    ...
    assert enrichment_response.status_code in [200, 202]
