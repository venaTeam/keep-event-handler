...
from config.consts import DEDUPLICATION_DISTRIBUTION_ENABLED, CUSTOM_DEDUPLICATION_DISTRIBUTION_ENABLED
...
class AlertDeduplicator:
    DEDUPLICATION_DISTRIBUTION_ENABLED = DEDUPLICATION_DISTRIBUTION_ENABLED
    CUSTOM_DEDUPLICATION_DISTRIBUTION_ENABLED = CUSTOM_DEDUPLICATION_DISTRIBUTION_ENABLED
